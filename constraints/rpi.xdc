...
##LED(GREEN)## 
#set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports { LEDA }]; #rpio_12
...
#set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { LEDD }]; #rpio_23
...
##Switches##
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33 } [get_ports { computer_position[0] }]; #rpio_14
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { computer_position[1] }]; #rpio_15
set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 } [get_ports { computer_position[2] }]; #rpio_16
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { computer_position[3] }]; #rpio_17
set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 } [get_ports { player_position[0] }]; #rpio_18
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { player_position[1] }]; #rpio_19
set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS33 } [get_ports { player_position[2] }]; #rpio_20
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { player_position[3] }]; #rpio_26
